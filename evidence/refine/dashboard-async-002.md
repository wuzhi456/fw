...
artifact_type: test
path_or_issue_pr: packages/core/src/hooks/data/useList.spec.ts
excerpt_or_summary: Tests assert list hook states across success and error.
mapped_experience_claim: Unit tests should cover hook state machines for async data.
