...
excerpt_or_summary: List component documents pagination props and total count handling.
mapped_experience_claim: Large collections should use server pagination with explicit page controls.
