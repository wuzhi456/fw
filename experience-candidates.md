...
| C-008 | list | 无 total 的分页控件 | react-admin list docs | evidence/react-admin/list-pagination-001.md; backup: evidence/gitlab/gitlab-list-pagination-001.md | merged→list-pagination-server |
...
| C-012 | list | 无限滚动重复 key | kibana perf PR | evidence/kibana/kibana-list-perf-002.md; backup: evidence/gitlab/gitlab-list-pagination-002.md | merged→list-incremental-prefetch |
| C-013 | form | Save 连点双建 | react-admin SaveButton | evidence/react-admin/form-dup-guard-001.md; backup: evidence/gitlab/gitlab-form-dup-guard-001.md | merged→form-duplicate-submit-guard |
| C-014 | form | 提交中无 pending 样式 | react-admin SaveButton code | evidence/react-admin/form-dup-guard-002.md; backup: evidence/gitlab/gitlab-form-dup-guard-002.md | merged→form-duplicate-submit-guard |
...
| C-025 | ux | 单组件错误白屏整页 | kibana issues | evidence/kibana/kibana-error-boundary-003.md; backup: evidence/gitlab/gitlab-ux-error-boundary-001.md | merged→ux-error-boundary-granularity |
| C-026 | ux | 错误边界过细导致噪音 | kibana contributing | evidence/kibana/kibana-error-boundary-001.md; backup: evidence/gitlab/gitlab-ux-error-boundary-002.md | merged→ux-error-boundary-granularity |
...
| C-030 | ux | 非阻塞错误呈现策略 | gitlab issues+RFC | evidence/gitlab/gitlab-ux-recoverable-errors-001.md | merged→ux-fallback-recoverable-errors |
